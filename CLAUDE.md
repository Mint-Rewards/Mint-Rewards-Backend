...
In short: a **Campaign** is a recycling *programme* ("what programme is this"),
a **Deal** is the consumer *incentive* ("what do I get"), a **Discount** is one
*type* of Deal (a price reduction), and a **coupon/promo code** is only the
